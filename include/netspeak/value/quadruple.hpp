...
public:
  ...
  quadruple(const quadruple& rhs) : e1_(rhs.e1_), e2_(rhs.e2_), e3_(rhs.e3_), e4_(rhs.e4_) {}
...
template <typename T1, typename T2, typename T3, typename T4>
inline bool operator==(const quadruple<T1, T2, T3, T4>& lhs, const quadruple<T1, T2, T3, T4>& rhs) {
